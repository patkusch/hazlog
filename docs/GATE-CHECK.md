...
| 5 | **Proof of gap** — obligation + incumbents | README *The obligation* cites DCB0160 v3.2 clauses 2.3.1, 3.1.4, 3.3.1–3.3.3, 4.3.1, 4.4.1 (read from the Requirements Specification PDF). README *The incumbents* table. | done. Matrix checked against the Implementation Guidance v4.2 Tables 7-10 and pinned by test |
